...
namespace WebApplicationv2.Controllers
{
    public class CarrerasController : Controller
    {
        ...
        {
            var fidelitasContext = _context.Carrera.Include(c => c.IdUniversidadNavigation);
        ...
        {
            ViewData["IdUniversidad"] = new SelectList(_context.Universidad, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,GradoAcademico,AcreditadaSinaes,Creacion,Decano,Precio,RequisitoGraduacion,Desactivado,IdUniversidad")] Carrera carrera)
        {
            ...
            ViewData["IdUniversidad"] = new SelectList(_context.Universidad, "Id", "Id", carrera.IdUniversidad);
            return View(carrera);
        }
